"""
Reference: 
https://github.com/Laudarisd/Data_preprocessing/blob/main/csv_to_voc_xml.py
"""
...
def write_xml(folder, filename, bbox_list):
    ...
    xml_filename = os.path.join(
        '.', folder, os.path.splitext(filename)[0] + '.xml')
    tree.write(xml_filename)


save_paths = ["../../input/train_xmls", "../../input/valid_xmls"]
csv_files = ["../../input/train.csv", "../../input/valid.csv"]
