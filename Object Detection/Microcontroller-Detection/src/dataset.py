...
from config import CLASSES, RESIZE_TO, TRAIN_DIR, VALID_DIR, OUT_DIR, BATCH_SIZE
from torch.utils.data import Dataset, DataLoader
from utils import collate_fn, get_train_transform, get_valid_transform, draw_boxes
